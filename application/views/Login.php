                        ...
                        <div class="col-md-4 col-10 box-shadow-2 p-0">
                            <div class="card border-grey border-lighten-3 m-0">
                                    ...
                                    <div class="card-body">
                                        <form class="form-horizontal form-simple" action="<?php echo site_url('Login/validate')?>" method="post">
                                            <fieldset class="form-group position-relative has-icon-left mb-0">
                                                <input type="text" class="form-control form-control-lg" name="username" id="user-name" placeholder="Your Username" required>
                                ...
                                <div class="card-footer">
                                    <div class="">
                                        <p class="float-sm-right text-center m-0">Not Have Account ?
                                            <a href="<?=site_url('Register')?>" class="card-link">Create Account</a>
                                        </p>
                                    </div>
                                </div>
                            </div>
